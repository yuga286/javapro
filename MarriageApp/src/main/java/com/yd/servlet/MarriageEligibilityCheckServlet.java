...
import jakarta.servlet.ServletExcetion;
...
public class MarriageElgibilityCheckServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse res)throws ServletException, IOException
	{
		...
		int age=Integer.parselnt(req.getParameter("page"));
		...
		if(gen.equalsIgnoreCase("M")) {
			...
			pw.println("<br><br><a href='http://localhost:8080/MarriageApp/input.html'><'image src='image/home.png'></a>");
		pw.close();
}
